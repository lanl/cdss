...
<div style="display:inline-block; margin-bottom: 50px;">
<img src="/cdss/assets/img/andres_yague_lopez.png" style="margin-right:15px; width: 30%; float: left;"/>

CAI-1 Applied Computer Science

Andrés is a staff scientist in CAI-1 with a background in numerical methods, solar physics and nuclear astrophysics. He has worked in magnetohydrodinamics, nucleosynthesis and galactic chemical evolution simulations, including stiff nuclear networks, developing novel numerical methods for the latter. He is interested in developing simulations that can take full advantage of HPC systems capabilities.
...
<div style="display:inline-block; margin-bottom: 50px;">
<img src="/cdss/assets/img/reisner_ment.jpg" style="margin-right:15px; width: 30%; float: left;"/>
...
<div style="display:inline-block; margin-bottom: 50px;">
<img src="/cdss/assets/img/philipp.jpeg" style="margin-right:15px; width: 30%; float: left;"/>

CAI-1 Applied Computer Science

Philipp is a staff scientist in CAI-1 with a background in stellar
...
<div style="display:inline-block; margin-bottom: 50px;">
<img src="/cdss/assets/img/Sumathi.png" style="margin-right:15px; width: 30%; float: left;"/>
...
<h1> Founder </h1>
<div style="display:inline-block; margin-bottom: 50px;">
<img src="/cdss/assets/img/al-1.jpg" style="margin-right:15px; width: 30%; float: left;"/>
Allen McPherson <br>
